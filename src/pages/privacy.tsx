        ...
        <>
            <main className={styles.main}>
                ...
                <h1 className={privacyStyles.header}>Privacy Policy</h1>
                    ...
                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>TABLE OF CONTENTS</h2>
                        <ul>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>1. WHAT INFORMATION DO WE COLLECT?</a></li>
                            <li><a href="#processInfo" className={privacyStyles.blueLink}>2. HOW DO WE PROCESS YOUR INFORMATION?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>6. HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>7. HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>8. WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>9. CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>10. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>11. DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
                            <li><a href="#infoCollection" className={privacyStyles.blueLink}>13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
                        </ul>
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>1. WHAT INFORMATION DO WE COLLECT?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>8. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>9. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>10. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                        
                    </section>

                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                        <p className={privacyStyles.sectionContent}>
                    ...
                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                        <p>
                        If you have questions or comments about this notice, you may email us at stevenchen@servicementoscholars.org or contact us by post at:
                        </p>
                        <address>
                            Servicemen to Scholars LLC<br/>
                            236 Jennings Ct<br/>
                            Mickleton NJ<br/>
                            United States
                        </address>  
                    ...
                    <section className={privacyStyles.section}>
                        <h2 className={privacyStyles.sectionTitle}>13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                        <p>
